...
!function (t, e) {
  ...
  Fn = function (i) {
    ...
    var l = {
      ...
      getTransitionDurationFromElement: function (t) {
        ...
        return parseFloat(e) ? (e = e.split(',') [0], 1000 * parseFloat(e)) : 0
      },
      reflow: function (t) {
  ...
  Qn = (j = 'carousel', L = '.' + (H = 'bs.carousel'), R = '.data-api', x = (P = e).fn[j], W = {
    ...
    t._setActiveIndicatorElement = function (t) {
      if (this._indicatorsElement) {
        var e = [
        ].slice.call(this._indicatorsElement.querySelectorAll($));
        P(e).removeClass(V);
    ...
    for (var t = [
    ].slice.call(document.querySelectorAll(rt)), e = 0, n = t.length; e < n; e++) {
      var i = P(t[e]);
  ...
  Bn = (at = 'collapse', ct = '.' + (lt = 'bs.collapse'), ht = (st = e).fn[at], ut = {
    ...
    function a(e, t) {
      ...
      for (var n = [
      ].slice.call(document.querySelectorAll(Ct)), i = 0, r = n.length; i < r; i++) {
        var o = n[i],
        s = Fn.getSelectorFromElement(o),
        a = [
        ].slice.call(document.querySelectorAll(s)).filter(function (t) {
          return t === e
        });
    ...
    t.show = function () {
      ...
      e,
      n = this;
      if (!this._isTransitioning && !st(this._element).hasClass(gt) && (this._parent && 0 === (t = [
      ].slice.call(this._parent.querySelectorAll(Et)).filter(function (t) {
  ...
  Vn = (St = 'dropdown', At = '.' + (It = 'bs.dropdown'), Dt = '.data-api', wt = (bt = e).fn[St], Nt = new RegExp('38|40|27'), Ot = {
    ...
    c._clearMenus = function (t) {
      if (!t || 3 !== t.which && ('keyup' !== t.type || 9 === t.which)) for (var e = [
      ].slice.call(document.querySelectorAll(Wt)), n = 0, i = e.length; n < i; n++) {
    ...
    c._dataApiKeydownHandler = function (t) {
      if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || bt(t.target).closest(qt).length)) : Nt.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !bt(this).hasClass(kt))) {
        ...
        if ((n || 27 === t.which && 32 === t.which) && (!n || 27 !== t.which && 32 !== t.which)) {
          var i = [
          ].slice.call(e.querySelectorAll(Kt));
          if (0 !== i.length) {
  ...
  Yn = (Xt = 'modal', ee = '.' + (te = 'bs.modal'), ne = ($t = e).fn[Xt], ie = {
    ...
    t._setScrollbar = function () {
      ...
      if (this._isBodyOverflowing) {
        var t = [
        ].slice.call(document.querySelectorAll(ge)),
        e = [
        ].slice.call(document.querySelectorAll(_e));
  ...
  Zn = (en = 'scrollspy', rn = '.' + (nn = 'bs.scrollspy'), on = (tn = e).fn[en], sn = {
    ...
    return t.refresh = function () {
      ...
      [
        ...
        if (n && (e = document.querySelector(n)), e) {
          ...
          if (i.width || i.height) return [tn(e) [r]().top + o,
          n]
        }
        return null
      }).filter(function (t) {
    ...
    for (var t = [
    ].slice.call(document.querySelectorAll(un)), e = t.length; e--; ) {
      var n = tn(t[e]);
  ...
  Gn = (In = '.' + (Sn = 'bs.tab'), An = (bn = e).fn.tab, Dn = {
    ...
    t._transitionComplete = function (t, e, n) {
      ...
      if (bn(t).addClass(Nn), 'tab' === t.getAttribute('role') && t.setAttribute('aria-selected', !0), Fn.reflow(t), bn(t).addClass(Pn), t.parentNode && bn(t.parentNode).hasClass(wn)) {
        ...
        if (r) {
          var o = [
          ].slice.call(r.querySelectorAll(Wn));
          bn(o).addClass(Nn)
        }
